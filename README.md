...
[![CDNJS](https://img.shields.io/cdnjs/v/element-m.svg)](https://cdnjs.com/libraries/element-m)
[![npm package](https://img.shields.io/npm/v/element-m.svg)](https://www.npmjs.org/package/element-m)
[![NPM downloads](http://img.shields.io/npm/dm/element-m.svg)](https://npmjs.org/package/element-m)
![JS gzip size](http://img.badgesize.io/https://unpkg.com/element-m/lib/index.js?compression=gzip&label=gzip%20size:%20JS)
![CSS gzip size](http://img.badgesize.io/https://unpkg.com/element-m/lib/theme-default/index.css?compression=gzip&label=gzip%20size:%20CSS)
...
## Install
```shell
npm install element-m -S
```

## Quick Start
``` javascript
import Vue from 'vue'
import Element from 'element-m'
