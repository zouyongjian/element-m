...
<script type="text/babel">
  ...
  import { PopupManager } from 'element-m/src/utils/popup';
  import Locale from 'element-m/src/mixins/locale';
  import Clickoutside from 'element-m/src/utils/clickoutside';
  import Dropdown from './dropdown';
  import ElCheckbox from 'element-m/packages/checkbox';
  import ElCheckboxGroup from 'element-m/packages/checkbox-group';
